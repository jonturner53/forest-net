...
void basicTests() {
	...
	l1.removeNext(5); s1.clear(); l1.add2string(s1);
	Utest::assertEqual(s1, "[ c e i ]",
		"mismatch on list [ c e i ]");

	l1.removeNext(0); s1.clear(); l1.add2string(s1);
	Utest::assertEqual(s1, "[ e i ]",
		"mismatch on list [ e i ]");

	l1.removeFirst(); s1.clear(); l1.add2string(s1);
	Utest::assertEqual(s1, "[ i ]",
		"mismatch on list [ i ]");
