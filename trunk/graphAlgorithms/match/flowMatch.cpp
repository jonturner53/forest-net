...
void flowMatch(wgraph& G, dlist& M, int& size, int& weight) {
// Find a maximum weight matching in the bipartite graph G and
// return it as a list of edges.
	vertex u,v; edge e;

	wflograph F(G.n()+2,G.n()+G.m(),G.n()+1,G.n()+2);
	list X(G.n());
