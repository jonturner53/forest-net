// usage: ssets_d [ seed ]
//
// Ssets_d is a test program for the ssets data structure.
...
//	join s1 i s2	join sset s1, s2 at item i
//	split i s	split sset s on item i and print the resulting trees
