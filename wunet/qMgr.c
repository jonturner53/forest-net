...
qMgr::qMgr(int nL1, int nP1, int nQ1, int qL1, pktStore *ps1,
	   lnkTbl *lt1, lcTbl *lct1, int myLcn1)
...
// is up to the caller to discard packets that are not queued.
	int pleng = truPktLeng(ps->leng(p));
